...
function Player() {
  ...
  return (
    <div className="bg-white h-full border-black border-4 border-opacity-100 shadow-groovy">
      ...
      <div className="flex justify-center">
        <img className="w-60 md:w-auto h-auto border-4 m-5" src={session?.user?.image} alt="" />
      ...
      <div className="mx-4">
        <div className="flex flex-row p-2 border-b-4">
          ...
          <div className="basis-1/2">Album</div>
        ...
        <div className="flex flex-row p-2 hover:bg-groovyBlue">
          <div className="flex justify-start basis-1/2 space-x-2">
            ...
            <div className="flex flex-row">
              <div>
                <img className="w-10 md:w-auto h-auto" src={session?.user?.image} alt="" />
              </div>
              <div className="flex flex-col justify-center">
